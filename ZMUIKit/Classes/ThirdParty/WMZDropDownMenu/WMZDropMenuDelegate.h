...
/// 更换标题
-(NSString *) replaceTitlemenu:(WMZDropDownMenu *)menu didSelectIndexPath:(NSIndexPath *)indexPath;
/*
*自定义标题按钮视图  返回配置 参数说明
 offset       按钮的间距
 y            按钮的y坐标   自动会居中
...
*cell点击方法
*/
- (void)menu:(WMZDropDownMenu *)menu cell:(WMZDropIndexPath *)dropIndexPath
   dataIndexPath:(NSIndexPath*)indexpath data:(WMZDropTree*)data;
