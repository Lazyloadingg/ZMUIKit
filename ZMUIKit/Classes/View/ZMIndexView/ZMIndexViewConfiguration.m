...
const NSUInteger ZMIndexViewInvalidSection = NSUIntegerMax - 1;
const NSInteger ZMIndexViewSearchSection = -1;
...
@interface ZMIndexViewConfiguration ()

@property (nonatomic, assign) ZMIndexViewStyle indexViewStyle;  // 索引元素之间间隔距离

@end

@implementation ZMIndexViewConfiguration

@synthesize indexViewStyle = _indexViewStyle;

+ (instancetype)configuration
{
    return [self configurationWithIndexViewStyle:ZMIndexViewStyleDefault];
}
...
{
    ZMIndexViewConfiguration *configuration = [self new];
