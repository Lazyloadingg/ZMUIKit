...
@interface ZMImageEditorView ()

@property (nonatomic, assign) BOOL isMoving;

@end

@implementation ZMImageEditorView
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if ([self.delegate respondsToSelector:@selector(editorView:anchorPointIndex:rect:)]) {
        [self.delegate editorView:self anchorPointIndex:touches.anyObject.view.tag rect:self.lineWrap.frame];
    }
...
- (UIView *)maskView {
    if (!_maskView) {
        ...
        _maskView.backgroundColor = [UIColor colorWithWhite:0 alpha:.5f];
...
- (UIView *)imageWrap {
    if (!_imageWrap) {
        ...
        UIImageView *topLeft = [[UIImageView alloc] initWithImage:[UIImage zm_kitImageNamed:@"zm_kit_cycle_top_left"]];
        topLeft.tag = 0;
        ...
        UIImageView *topright = [[UIImageView alloc] initWithImage:[UIImage zm_kitImageNamed:@"zm_kit_cycle_top_right"]];
        topright.tag = 1;
        ...
        UIImageView *bottomLeft = [[UIImageView alloc] initWithImage:[UIImage zm_kitImageNamed:@"zm_kit_cycle_bottom_left"]];
        bottomLeft.tag = 2;
        ...
        UIImageView *bottomRight = [[UIImageView alloc] initWithImage:[UIImage zm_kitImageNamed:@"zm_kit_cycle_bottom_right"]];
        bottomRight.tag = 3;
