...
+ (ZMTimerDataSourceModel *)configDataSource {
    ...
    ZMTimerDataSourceModel *dataSourceModel = [ZMTimerDataSourceModel new];
    ...
    for (int i = 0; i < kDays; i++) {
        ...
        ZMDateModel *model = [[ZMDateModel alloc]init];
    ...
    for (NSInteger i = beginHour; i < 24 ; i++) {
        ZMHourModel *model = [[ZMHourModel alloc]init];
        if (i < 10) {
    ...
    for (NSInteger i = minStart; i < 60 / kTimeInterval; i++) {
        ZMMinuteModel *model = [[ZMMinuteModel alloc]init];
